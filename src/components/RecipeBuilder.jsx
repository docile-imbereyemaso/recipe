const RecipeBuilder = (props) => {
  ...
  return (
    <div className="flex justify-between items-center bg-zinc-200 p-5 rounded-md">
      ...
      <button
        onClick={getRecipeMarkdown}
        className="bg-terra px-4 py-3 rounded-lg text-white hover:text-zinc-100/50 transition-all focus:ring-terra focus:ring-2 focus:ring-offset-2"
      >
        Get a recipe
      </button>
    </div>
